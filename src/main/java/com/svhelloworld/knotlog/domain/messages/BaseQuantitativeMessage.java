...
public abstract class BaseQuantitativeMessage<M extends MeasurementUnit>
    ...
    /**
     * @see com.svhelloworld.knotlog.domain.messages.QuantitativeMessage#getMeasurementUnit()
     */
    @Override
    ...
    /**
     * @see com.svhelloworld.knotlog.domain.messages.QuantitativeMessage#getQuantity()
     */
    @Override
